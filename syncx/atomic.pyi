...
class AtomicReference:
    ...
    def set(self, obj: Any | None) -> None: ...
    def exchange(self, obj: Any | None) -> Any | None: ...
    def compare_exchange(self, expected: Any | None, obj: Any | None) -> bool: ...
    def __repr__(self) -> str: ...
    def __str__(self) -> str: ...
    def __getstate__(self) -> Any | None: ...
    def __setstate__(self, obj: Any | None) -> None: ...

__all__ = ["AtomicInt", "AtomicBool", "AtomicFloat", "AtomicReference"]
